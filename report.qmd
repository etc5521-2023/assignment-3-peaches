...
-   This helps us assess whether the population is declining as
    expected.
-   We see that the actual trend is not aligning with our expectation, we see a       relatively flat trend with minimal sightings from around 2000 up until            approximately 2015 and significant spike in sightings around 2020.
...
hp <- ggplot(temporal_data, aes(x = Quarter, y = as.factor(Year), fill = Trips)) +
  geom_tile() +
