...
Upon analysing the Woylie sightings for the Narrabri region, we observe that the sightings in this region are recorded solely for the year of 2022. The entailing reasons for such unusual occurrences of the Woylies in this region have been further delineated in @sec-reason.
...
@fig-monthly illustrates that the number of Woylie sightings varied throughout the year, but the highest number of sightings occurred in the spring season (between September to Deecember). The sightings in the other seasons were observed to be equally distributed. This clearly suggests that the Woylies are likely to be sighted towards the later part of the year in the spring season.
...
To delve into the relation between temperature and sightings, we can explore dumbbell charts that unveil how temperature variables like 'tmax' or 'tmin' correlate with the observed number of sightings as illustrated by @fig-temp.
...
## Tourists & Species Sightings {#sec-reason}
