...
sightings_per_year <- aggregate(eventDate ~ year, WILD_THING_woylie, length)
ggplot(sightings_per_year, aes(x = year, y = eventDate)) +
...
6.Among the specific purposes, "Visiting" trips dominate, followed by "Holiday" trips. "Business" and "Other" have a relatively lower volume of trips, with "Business" trips being the least common.
