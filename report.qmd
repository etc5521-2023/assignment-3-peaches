...
hp <- ggplot(plot_data, aes(x = Quarter, y = Year, fill = Trips)) +
  geom_tile() +
  scale_fill_gradient(name = "Trips (in 1000s)", low = "white", high = "darkred") +  
...
1. There appears to be an increasing trend in the number of trips from 1998 until around 2021-2022. The darker shades in more recent years, especially around 2021-2022, indicate more trips compared to the lighter shades in earlier years. It indicates a cyclic nature of the trip volumes with peaks and troughs. 

2. **Q1**: The trips in Q1 seems Q1 has demonstrated fluctuations over the years, starting with low activity in the late 1990s to early 2000s, experiencing a rise in the mid 2000s, stabilizing in the late 2000s to early 2010s, and then witnessing another increase in the recent years, notably 2022.

3. **Q2** : This quarter appears to have moderate activity over the years

4. **Q3** :  The consistent dark shades for Q3 indicate a substantial number of trips, especially in the recent years from 2016 onwards. 

5. **Q4** : Activity in Q4 is on the lower side, with lighter shades indicating fewer trips.
